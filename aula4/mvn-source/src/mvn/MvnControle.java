...
public class MvnControle {
    ...
    private static final String DEV_NAME_FIBONACCI = "Fibonacci";
     ...
     *
     * @param output Classe descendente de Appendable onde a saída da
     * inicialização da MVN deve ser escrita.
     * @throws MVNException caso ocorra algum erro na inicialização.
     */
    public void initialize(StringBuilder output) throws MVNException {
    ...
    /**
     * Exportar em formato texto o conteúdo dos registradores da MVN, com
     * cabeçalho.<br/>
     * <br/>
     * <b>Pré-condição</b>: Nenhuma.<br/>
     ...
     * válido.<br/>
     * <b>Pós-condição</b>: Um dump do intervalo especificado da memória é
     * feito.
     *
     ...
     * @throws MVNException Caso o intervalo de memória seja inválido.
     */
     ...
     * Caso a memória seja alterada, o primeiro endereço alterado pelo arquivo é
     * passado para o registrador de endereço de instrução (IC).<br/>
     * <br/>
     * <b>Pré-condição</b>: O arquivo deve existir e estar no formato
     * correto.<br/>
    ...
    /**
     * Adquire a lista de dispositivos disponível para MVN em formato
     * texto.<br/>
     * <br/>
     * <b>Pré-condição</b>: Nenhuma.<br/>
     ...
     * <b>Pós-condição</b>: A MVN é inicializada.
     *
     * @param addr Endereço da memória contendo o ponto de entrada do programa.
     * @param showRegs Indica se o estado dos registradores deve ser exibido a
     * cada passo da MVN.
     * @param output Instância do objeto que armazenará a saída da MVN.
     * @throws MVNException Caso não seja possível iniciar a MVN.
     */
    public void start(int addr, boolean showRegs)
            throws MVNException {
     ...
     * Registrador de Endereço de Instrução - IC).<br/>
     * <br/>
     * <b>Pré-condição</b>: A MVN deve estar inicializada (método start()).<br/>
     * <b>Pós-condição</b>: A instrução é processada e executada.
     *
     * @return TRUE caso a MVN não tenha encontrado uma instrução de parada,
     * FALSE caso contrário.
     * @throws MVNException Caso ocorra algum problema no processamento da
     * instrução.
     */
     ...
     * @throws MVNException Caso o dispositivo não exista.
     */
     ...
     * <br/>
     * <b>Pré-condição</b>: O tipo e unidade lógica especificados são
     * válidos.<br/>
     * <b>Pós-condição</b>: O dispositivo indicado é adicionado.
     *
     * @param tipo especifica o tipo de dispositivo a ser adicinado
     * @param unidadeLogica unidade lógica do dispositivo
     * @param params Parâmetros do dispositivo que está sendo adicionado
     * @throws MVNException Caso não seja possível adicionar o dispositivo.
     */
     ...
     * <b>Pós-condição</b>: O endereço atual da MVN, especificado pelo
     * Registrador de Endereço de Instrução - IC.
     *
     ...
     *
     * @param txt A mensagem a ser adicionada.
     */
